...
CONFIG.statusEffects = [
	{
		...
		img: "systems/rogue-trader/asset/icons/bleeding.png",
	},
	{
		id: "blinded",
		statuses: ["blinded"],
		name: "CONDITION.BLINDED",
		img: "systems/rogue-trader/asset/icons/blinded.png",
	},
	{
		id: "deafened",
		statuses: ["deafened"],
		name: "CONDITION.DEAFEND",
		img: "systems/rogue-trader/asset/icons/deafened.png",
	},
	{
		id: "fear",
		statuses: ["fear"],
		name: "CONDITION.FEAR",
		img: "systems/rogue-trader/asset/icons/fear.png",
	},
	{
		id: "fire",
		statuses: ["fire"],
		name: "CONDITION.FIRE",
		img: "systems/rogue-trader/asset/icons/flame.png",
	},
	{
		id: "grappled",
		statuses: ["grappled"],
		name: "CONDITION.GRAPPLED",
		img: "systems/rogue-trader/asset/icons/grappled.png",
	},
	{
		id: "hidden",
		statuses: ["hidden"],
		name: "CONDITION.HIDDEN",
		img: "systems/rogue-trader/asset/icons/hidden.png",
	},
	{
		id: "pinned",
		statuses: ["pinned"],
		name: "CONDITION.PINNED",
		img: "systems/rogue-trader/asset/icons/pinning.png",
	},
	{
		id: "poisond",
		statuses: ["poisond"],
		name: "CONDITION.POISONED",
		img: "systems/rogue-trader/asset/icons/poisoned.png",
	},
	{
		id: "prone",
		statuses: ["prone"],
		name: "CONDITION.PRONE",
		img: "systems/rogue-trader/asset/icons/prone.png",
	},
	{
		id: "stunned",
		statuses: ["stunned"],
		name: "CONDITION.STUNNED",
		img: "systems/rogue-trader/asset/icons/stunned.png",
	},
	{
		id: "unconscious",
		statuses: ["unconscious"],
		name: "CONDITION.UNCONSCIOUS",
		img: "systems/rogue-trader/asset/icons/unconscious.png",
	},
	{
		id: "dead",
		statuses: ["dead"],
		name: "EFFECT.StatusDead", // Foundry Default Text Key
		img: "systems/rogue-trader/asset/icons/dead.png",
	},
];
